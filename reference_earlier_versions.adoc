...
[role="lead"]
VMware vCenter Server용 NetApp Element 플러그인 버전 5.2 이전 릴리즈에 대한 설명서도 제공됩니다.


NOTE: 여기 link:index.html["설명서 링크"] Element vCenter 플러그인 5.2에는 버전 5.1, 5.0, 4.10, 4.9, 4.8, 4.7 및 4.6.
