...
[role="lead"]
또한 VMware vCenter Server용 NetApp Element 플러그인 5.4 이전 버전의 릴리즈에 대한 설명서도 제공됩니다.


NOTE: link:index.html["설명서 링크"]Element vCenter 플러그인 5.4용 버전 5.3, 5.2, 5.1, 5.0, 4.10, 4.9, 4.8, 4.7 및 4.6 버전도 포함됩니다.
