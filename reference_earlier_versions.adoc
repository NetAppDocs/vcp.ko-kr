...
[role="lead"]
VMware vCenter Server용 NetApp Element 플러그인 5.0 이전 버전에도 설명서가 제공됩니다.


NOTE: 여기 link:index.html["설명서 링크"] Element vCenter 플러그인 5.0의 경우 버전 4.6, 4.7, 4.8, 4.9 및 4.10도 포함됩니다.
