...
[role="lead"]
vCenter Server용 NetApp Element 플러그인 버전 4.9 이전의 릴리즈에도 설명서가 제공됩니다.


NOTE: 여기 link:index.html["설명서 링크"] vCenter Server용 NetApp Element 플러그인 버전 4.9의 경우 버전 4.6, 4.7 및 4.8도 포함됩니다.
